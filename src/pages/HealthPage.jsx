    ...
    try {
      ...
      if (healthData.heartRate && healthData.bodyTemperature) {
        ...
        if (heartRate > 100 || heartRate < 60 || temperature > 37.5 || temperature < 36.5) {
          level = "위험";
        } else if (heartRate > 90 || heartRate < 70 || temperature > 37.2 || temperature < 36.8) {
          level = "경고";
        } else {
          level = "안정";
        }
    ...
    <div className="min-h-screen bg-[#F8F8F8]">
      <div className="mx-auto w-full max-w-[1120px] px-6 py-16">
        ...
        <div className="space-y-6">
          <div className={`${getBackgroundClass(aiLevel)} rounded-xl shadow-2xl p-6`}>
            <div className="flex flex-col space-y-6">

              <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-gray-900">현재 건강 상태</h3>
                ...
                <div className="flex space-x-4">
                  <div className="flex-1 text-center">
                    ...
                    <div className="text-xs text-blue-500 mt-1">정상: 60-100</div>
                  </div>
                  ...
                  <div className="flex-1 text-center">
                    ...
                    <div className="text-xs text-green-500 mt-1">정상: 36.5-37.5</div>
                  </div>
                </div>
              </div>
              ...
              {/* AI 예측 */}
              <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200">
                <h3 className="text-lg font-bold text-gray-900 mb-4">AI 위험도 예측</h3>
                <AIPrediction healthData={healthData} weatherData={null} showDetails={true} />
              </div>
              ...
              <div className="flex space-x-6">
                <div className="flex-1 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{healthData?.deviceType || "스마트워치"}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="flex-1 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-gray-200">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">건강 관리 팁</h3>
