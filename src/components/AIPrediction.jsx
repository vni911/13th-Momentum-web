  ...
  useEffect(() => {
    const run = async () => {
      ...
      try {
        ...
        const payload = {
          hr:
            healthData && healthData.heartRate != null
              ? healthData.heartRate
              : null,
          skin_temp:
            healthData && healthData.skinTemperature != null
              ? healthData.skinTemperature
              : healthData && healthData.bodyTemperature != null
              ? healthData.bodyTemperature
              : null,
          env_temp:
            weatherData && weatherData.temp != null ? weatherData.temp : null,
          humidity:
            weatherData && weatherData.humidity != null
              ? weatherData.humidity / 100
              : null,
          sun:
            weatherData && weatherData.uv != null && weatherData.uv > 5 ? 1 : 0,
        };
